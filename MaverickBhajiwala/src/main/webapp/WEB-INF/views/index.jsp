	...
	<section class="ftco-section ftco-category ftco-no-pt">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-4 order-md-last align-items-stretch d-flex">
							<div
								...
								<div class="text text-center">
									...
									<p>
										<a href="${pageContext.request.contextPath}/shop/shopPage/0/12/0" class="btn btn-primary">Shop now</a>
									</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div
								...
								style="background-image: url(${pageContext.request.contextPath}${productCategoryList.getImageUrl()});">
								<div class="text px-3 py-1">
									<h2 class="mb-0">
										<a href="${pageContext.request.contextPath}/shop/shopPage/0/12/${productCategoryList.getId()}">${productCategoryList.getName()}</a>
									</h2>
								</div>
							</div>
						<%-- 	<div
								...
								<div class="text px-3 py-1">
									<h2 class="mb-0">
										<a href="#">${productCategoryList.getName()}</a>
									</h2>
								</div>
							</div> --%>
						</div>
